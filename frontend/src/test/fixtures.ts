...
export const groundedCoachAnalysisFixture: CoachAnalysis = {
  ...
  sources: [
    ...
    {
      citation_id: "S2",
      source_id: "lichess-king-safety",
      title: "King Safety",
      chapter: "Open Lines Around the King",
      phase: "middlegame",
      category: "king_safety",
      author: "Lichess study author",
      attribution: "https://lichess.org/@/study-author",
      content_license: "Public Lichess study; no explicit reuse license",
      license_url: null,
      canonical_url: "https://lichess.org/study/king-safety",
    },
  ],
};
